...
## Description
Polycyclic aromatic compounds (PACs) are an important class of organic contaminants that can be divided into several subclasses.
...
- `script.Rmd`: Main analysis R Markdown file
